    ...
    (function ($, document, window) {
        ...
        CollisionDetection.prototype.leveler = function (els) {
            ...
            els.each(function (i) {
                ...
                var this_props = {
                    ...
                    'top'       : this_ele.position().top, //test
                ...
                var next_props = (next_ele.length > 0) ? {
                    ...
                    'top'       : next_ele.position().top, //test
        ...
        CollisionDetection.prototype.setDimensions = function () {
            ...
            $(o.levelMemory.levelObjects).each(function (i) {
                ...
                // TEST level.css('bottom', i === 0 ? 0 : prevHeight);
                var baseline = level[0]["offsetTop"]; //test
                level.css('top', i === 0 ? baseline : baseline - prevHeight); //test
                prevHeight += thisHeight;
            });
            //set container to match height of elements inside
            t.container.css({
                // TEST height: prevHeight
            });
        };
